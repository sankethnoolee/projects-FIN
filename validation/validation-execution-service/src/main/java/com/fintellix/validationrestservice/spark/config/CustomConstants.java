package com.fintellix.validationrestservice.spark.config;
...
public class CustomConstants {
	...
	public static final String SPEL_EVAL_UDF_NAME = "spelEvalUdf";
    ...
    public static final String SPEL_COLUMN_NAME = "spelExpr";
    public static final String SPEL_EVAL_COLUMN_NAME = "op";
}
