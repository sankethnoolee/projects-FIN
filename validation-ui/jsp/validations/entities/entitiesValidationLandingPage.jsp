...
<head>
	...
	<!--<link rel="stylesheet" type="text/css" href="style/modules/validations/entities/returnValidation.css" />	-->
	<link rel="stylesheet" type="text/css" href="style/modules/validations/entities/returnValidationLandingPage.css"/>
	<link rel="stylesheet" type="text/css" href="style/modules/validations/entities/returnValidationCreateAndEdit.css" />
	<link rel="stylesheet" type="text/css" href="style/modules/validations/entities/vs.css" />

 	<script src="js/framework/validations/entities/jquery-1.11.0.min.js"></script>
 	<link rel="stylesheet" type="text/css" href="style/modules/validations/entities/jquery-u.1.10.4.css"/>
 	<script src="js/framework/validations/entities/jquery-ui-1.10.4.min.js"></script>
	...
	<!--<script src="js/framework/validations/entities/returnValidation.js"></script>-->
	<script src="js/framework/validations/entities/entitesValidationCreateAndEdit.js"></script>
	<script src="js/framework/validations/entities/entitesValidationLandingPage.js"></script>
	
	<script src="js/framework/validations/entities/entitesValidationExpressionPage.js"></script>
	<script src="js/framework/validations/entities/expressionGrammar.js"></script>
		<script src="js/framework/validations/entities/antlrJavascript/require.js"></script>
	<script src="js/framework/validations/entities/antlrJavascript/antlrExpression.js"></script>
	<script src="js/framework/validations/entities/common.js"></script>
	<script src="js/framework/validations/entities/vs-script.js"></script>
...
<body>
	...
	<div id="validationListContainer">
		<div class="vs-gc-header-comp" id="headerCompLandingPage">
			<div><h3 class="vs-h3-light-primary">Data Quality Rules</h3></div>
			<div>
		...
		<div class="vs-gc-flex-grid vs-top-mgn-16" id="flexGridDropDown">
			<div class="vs-flex-item-15" ><p class="vs-body-regular-primary">
				<div class="vs-gc-lbl-comp">
					<label class="vs-body-regular-primary vs-right-pad-8" for="textid">Entity</label>
			...
			<div class="vs-flex-item-15" ><p class="vs-body-regular-primary">
				<div class="vs-gc-lbl-comp">
					<label class="vs-body-regular-primary vs-right-pad-8" id = "rule-type-header" for="textid">Rule Type</label>
					<span class="vs-dropdown big">
						<select id="rule-type-select-id" class="applyButtonEnableDisable">
							<option value="" selected>All</option>
						</select>
					</span>
				</div>
		  ...
		  <main class="lay-right-aside">
			<aside>
				<div class="vs-section-default">
					<p class="vs-caption-uppercase-text">IMPORT DATA QUALITY RULES</p>
			...
			<aside>
				...
				<div class="vs-gc-flex-grid vs-top-mgn-16">
				  <div class="vs-flex-item-40 vs-left-pad-16"><p class="vs-body-regular-primary">
					<label class="vs-body-regular-primary" for="textid">Entity</label>
				  </p></div>
				...
				<div class="vs-gc-flex-grid vs-top-mgn-16">
				  <div class="vs-flex-item-40 vs-left-pad-16"><p class="vs-body-regular-primary">
					<label class="vs-body-regular-primary" for="textid">Rule Type</label>
				  </p></div>
				  <div class="vs-flex-item-55"><p class="vs-body-regular-primary vs-top-mgn-8">
					<select id="rule-type-exportDef-dropdown" class="vs-multiSelect exportDef" multiple="multiple">
					</select>
				  </p></div>
				  <div class="vs-flex-item-5 vs-left-pad-8"><p class="vs-body-regular-primary"></p></div>
				</div>
...
<div id="validation-create-edit-con" style="display:none;">
	...
	<div id="basicInformationPanel" class="vs-accordion-panel vs-top-mgn-16">
		...
		<div class="vs-gc-flex-grid vs-top-mgn-16 class2">
			...
			<div class="vs-gc-flex-grid">
				  <div class="vs-flex-item-40 vs-left-pad-16" ><p class="vs-body-regular-primary">
						<div class="vs-gc-lbl-comp">
							<div class="vs-right-mgn-32"><label class="vs-body-regular-primary" for="textid">Entity Name<span class="mandatoryFied">*</span></label></div>
				  ...
				  <div class="vs-flex-item-40 vs-left-pad-16"><p class="vs-body-regular-primary">
					<div class="vs-gc-lbl-comp">
						<div><label class="vs-body-regular-primary" for="textid">Column<span class="mandatoryFied"></span></label></div>
						<span class="vs-dropdown big">
		...
		<div class="vs-gc-flex-grid">
			...
			<div class="vs-gc-flex-grid">
				  <div class="vs-flex-item-40 vs-left-pad-16" ><p class="vs-body-regular-primary">
						<div class="vs-gc-lbl-comp">
							<div class="vs-right-mgn-32"><label class="vs-body-regular-primary" for="textid">Rule Type<span class="mandatoryFied">*</span></label></div>
						<span class="vs-dropdown big vs-left-mgn-32">
							<select id="ruleTypeId" class="alertInlineValidationDropDown">
								<option value="" selected disabled>Select Option</option>
							</select>
						</span>
						</div>
				 ...
				 <div class="vs-flex-item-40 vs-left-pad-16" ><p class="vs-body-regular-primary">
						<div class="vs-gc-lbl-comp">
							<div><label class="vs-body-regular-primary" for="textid">Group<span class="mandatoryFied">*</span></label></div>
						<span class="vs-dropdown big ">
		...
		<div class="vs-gc-flex-grid vs-top-mgn-16 class2">
			...
			<div class="vs-gc-flex-grid">
				  <div class="vs-flex-item-40 vs-left-pad-16" ><p class="vs-body-regular-primary">
						<div class="vs-gc-lbl-comp">
							<div class="vs-right-mgn-32"><label class="vs-body-regular-primary" for="textid">Threshold Unit<span class="mandatoryFied"></span></label></div>
						<span class="vs-dropdown big vs-left-mgn-32">
							<select id="thresholdUnitId" class="alertInlineValidationDropDown">
								<option value="" selected>Select Option</option>
				  ...
				  <div class="vs-flex-item-40 vs-left-pad-16"><p class="vs-body-regular-primary">
					<div class="vs-gc-lbl-comp">
						<div><label class="vs-body-regular-primary" for="textid">Measured On<span class="mandatoryFied"></span></label></div>
						<span class="vs-dropdown big">
							<select id="measuredOnId" class="alertInlineValidationDropDown">
								<option value="" selected>Select Option</option>
								<option value="Invalid Occurrences" >Invalid Occurrences</option>
								<option value="Valid Occurrences" >Valid Occurrences</option>
							</select>
						</span>
					</div>
				  </p></div>
		...
		<div class="vs-gc-flex-grid">
			...
			<div class="vs-gc-flex-grid">
				  <div class="vs-flex-item-40 vs-left-pad-16" ><p class="vs-body-regular-primary">
						<div class="vs-gc-lbl-comp">
							<div class="vs-right-mgn-32"><label class="vs-body-regular-primary" for="textid">Acceptable Threshold<span class="mandatoryFied"></span></label></div>
							<input maxlength="256" class="vs-textbox alertInlineValidation vs-left-mgn-32" type="number" placeholder="Enter acceptable value here" id="aThreshhold" autocomplete="off">
						</div>
				  </p></div>
				 <div class="vs-flex-item-40 vs-left-pad-16" ><p class="vs-body-regular-primary">
						<div class="vs-gc-lbl-comp">
							<div><label class="vs-body-regular-primary" for="textid">Questionable Threshold<span class="mandatoryFied"></span></label></div>
						<input maxlength="256" class="vs-textbox alertInlineValidation" type="number" placeholder="Enter questionable value here" id="qThreshhold" autocomplete="off">
						</div>
				  </p></div>
			</div>
			</p></div>
		...
		<div class="vs-gc-flex-grid">
			<div class="vs-flex-item-50 vs-left-pad-16" ><p class="vs-body-regular-primary">
				<div id="validationDescExpressionEditor" class="expressionEditorDiv">
					...
					<textarea id="validationDescriptionTextArea" class="vs-textarea vs-top-mgn-8" rows="8" cols="50" name="" form="" placeholder="Enter text here..." style="resize:none;margin-top: 0px ! important;min-height:201px;text-transform: none !important;" spellcheck="false"></textarea>
				</div>
			</p></div>
    ...
    <div class="vs-notification-bar error" id="onChangeOfEffectiveDate" style="top:0;display:none;">
      <div>
       <p class="vs-body-regular-black">There is no entities for selected date.</p>
      </div>
      <div>
