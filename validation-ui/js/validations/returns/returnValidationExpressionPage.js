...
var columnTag = [];
var expressionObj = {};
var rootColumn = ["RTN", "REFTBL", "ENT"]; //dd changes
...
function getEntitySubjectAreaForAutoSuggestion() {
    $.ajax({
        ...
        complete: function(response) {
            ddEntity["subjectArea"] = response.responseJSON.success.model.subjectAreas;
            response = response.responseJSON.success.model.subjectAreas;
...
function getEntityTableColumnNameForAutoSuggestion(entityUuid) {
    $.ajax({
        ...
        success: function(response) {
            ddEntity["entityColumnName"] = response.success.model;
            response = response.success.model;
            for (var i = 0; i < response.length; i++) {
                var sourceObj = {};
