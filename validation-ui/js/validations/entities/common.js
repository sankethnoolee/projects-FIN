...
var functionsAndOperatorArray = [{
	...
	"expressionFormat": "FOREACH(ENT.<SubjectArea>.<EntityName>,[GroupByColumnNames],[FilterConditions]){ <Expression> }",
	"internalValue":"FOREACH(){}",
	"expressionFormatAuto": "FOREACH(ENT.SubjectArea.EntityName, GroupByColumnNames, [FilterConditions])",
	"include":"Y"
}, {
	"name": "SUM",
	"category": "Functions",
	...
	"name": "IF()THEN()ELSEIF()THEN()ELSE()",
	"category": "Functions",
	"subCategory": "COMMONLY USED",
	"expressionFormat": "IF(Condition1...ConditionN)THEN(Condition1...ConditionN)(ELSEIF(Condition1...ConditionN)THEN(Condition1...ConditionN)(optional))ELSE(Condition1...ConditionN)",
	"internalValue":"IF()THEN()ELSEIF()THEN()ELSE()",
	"expressionFormatAuto": "IF(Condition)THEN(Condition)(ELSEIF(Condition)THEN(Condition)(optional))ELSE(Condition)",
	"include":"Y"
},{
	"name": "ISEMPTY",
	"category": "Functions",
...
},
{
	...
	"category": "Operator",
	"subCategory": "COMMONLY USED",
	"expressionFormat": "<ColumnToBeEvaluated> DOESNOTCONTAINS [ListOfValues]",
	"internalValue":"DOESNOTCONTAINS[]",
	"expressionFormatAuto": "DOESNOTCONTAINS([ListOfValues])",
	"include":"Y"
},{
	"name": "FLOOR",
	"category": "Functions",
	"subCategory": "MATH",
	"expressionFormat": "FLOOR(<ColumnName/Value>,<Floor value>)",
	"internalValue":"FLOOR()",
	"expressionFormatAuto": "FLOOR(ColumnName/Value, Floor value)",
	"include":"Y"
}	
,{
	"name": "CEIL",
	"category": "Functions",
	"subCategory": "MATH",
	"expressionFormat": "CEIL(<ColumnName/Value>,<Ceil value>)",
	"internalValue":"CEIL()",
	"expressionFormatAuto": "CEIL(ColumnName/Value, Ceil Value)",
	"include":"Y"
},{
	"name": "COALESCE",
	"category": "Functions",
	"subCategory": "COMMONLY USED",
	"expressionFormat": "COALESCE(<ColumnName/Value>,<Default value if column is null>)",
	"internalValue":"COALESCE()",
	"expressionFormatAuto": "COALESCE(ColumnName/Value,Default value if column is null)",
	"include":"Y"
}, {
	"name": "TRIM",
	"category": "Functions",
	"subCategory": "TEXT",
	"expressionFormat": "TRIM(<ColumnName/Value1>)",
	"internalValue":"TRIM()",
	"expressionFormatAuto": "TRIM(Value1)",
	"include":"Y"
}, {
	"name": "REPLACE",
	"category": "Functions",
	"subCategory": "TEXT",
	"expressionFormat": "REPLACE(<ColumnName/Value1>,<Value to be replaced>,<New Value>)",
	"internalValue":"REPLACE()",
	"expressionFormatAuto": "REPLACE(<ColumnName/Value1>,Value to be replaced,New Value)",
	"include":"Y"
}, {
	"name": "SOQ",
	"category": "Functions",
	"subCategory": "DATE & TIME",
	"expressionFormat": "SOQ(<DateField>)",
	"internalValue":"SOQ()",
	"expressionFormatAuto": "SOQ(DateField)",
	"include":"Y"
}, {
	"name": "EOQ",
	"category": "Functions",
	"subCategory": "DATE & TIME",
	"expressionFormat": "EOQ(<DateField>)",
	"internalValue":"EOQ()",
	"expressionFormatAuto": "EOQ(DateField)",
	"include":"Y"
}	
