...
// Enter a parse tree produced by ValidationGrammarParser#doesNotContains.
ValidationGrammarListener.prototype.enterDoesNotContains = function(ctx) {
};

// Exit a parse tree produced by ValidationGrammarParser#doesNotContains.
ValidationGrammarListener.prototype.exitDoesNotContains = function(ctx) {
};
...
// Enter a parse tree produced by ValidationGrammarParser#floor.
ValidationGrammarListener.prototype.enterFloor = function(ctx) {
};

// Exit a parse tree produced by ValidationGrammarParser#floor.
ValidationGrammarListener.prototype.exitFloor = function(ctx) {
};


// Enter a parse tree produced by ValidationGrammarParser#ceil.
ValidationGrammarListener.prototype.enterCeil = function(ctx) {
};

// Exit a parse tree produced by ValidationGrammarParser#ceil.
ValidationGrammarListener.prototype.exitCeil = function(ctx) {
};
...
// Enter a parse tree produced by ValidationGrammarParser#column_spcl_char.
ValidationGrammarListener.prototype.enterColumn_spcl_char = function(ctx) {
};

// Exit a parse tree produced by ValidationGrammarParser#column_spcl_char.
ValidationGrammarListener.prototype.exitColumn_spcl_char = function(ctx) {
};
