...
public class DirectoryForUpload implements Serializable{
	...
	public DirectoryForUpload(){
		
	}
	
	public DirectoryForUpload(Directory dw,Integer hierarchyLevel){
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DirectoryForUpload other = (DirectoryForUpload) obj;
		if (createdTime == null) {
	...
	public String toString() {
		return "DirectoryForUpload [directoryId=" + directoryId
				+ ", parentDirectoryId=" + parentDirectoryId
				+ ", directoryName=" + directoryName + ", directoryDesc="
				+ directoryDesc + ", createdTime=" + createdTime
				+ ", modifiedTime=" + modifiedTime + ", creator=" + creator
				+ ", lastModifiedBy=" + lastModifiedBy + ", solutionId="
				+ solutionId + ", orgId=" + orgId + ", packageLocation="
				+ packageLocation + ", spaceId=" + spaceId + ", isPrivate="
				+ isPrivate + ", hierarchyLevel=" + hierarchyLevel
