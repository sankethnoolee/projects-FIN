...
public class Directory implements Serializable{
	...
	private String tilteOfTheFolder;
	public Directory(){
		super();
	}
	public Directory(DirectoryForUpload dw){
		this.setDirectoryId(dw.getDirectoryId());
		this.setParentDirectoryId(dw.getParentDirectoryId());
		this.setDirectoryName(dw.getDirectoryName());
		this.setDirectoryDesc(dw.getDirectoryDesc());
		this.setCreatedTime(dw.getCreatedTime());
		this.setModifiedTime(dw.getModifiedTime());
		this.setCreator(dw.getCreator());
		this.setLastModifiedBy(dw.getLastModifiedBy());
		this.setSolutionId(dw.getSolutionId());
		this.setOrgId(dw.getOrgId());
		this.setPackageLocation(dw.getPackageLocation());
		this.setSpaceId(dw.getSpaceId());
		this.setIsPrivate(dw.getIsPrivate());
		this.setIsInherited(true);
		this.setTilteOfTheFolder("");
	}
	...
	public String getTilteOfTheFolder() {
		return tilteOfTheFolder;
	}

	public void setTilteOfTheFolder(String tilteOfTheFolder) {
		this.tilteOfTheFolder = tilteOfTheFolder;
	}
	@Override
	public String toString() {
		return "Directory [directoryId=" + directoryId + ", parentDirectoryId="
				...
				+ spaceId + ", isPrivate=" + isPrivate + ", isInherited=" +isInherited+ ",tilteOfTheFolder=" + tilteOfTheFolder +"]";
	}
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((isInherited == null) ? 0 : isInherited.hashCode());
		result = prime * result
				+ ((tilteOfTheFolder == null) ? 0 : tilteOfTheFolder.hashCode());
		result = prime * result + ((spaceId == null) ? 0 : spaceId.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (spaceId == null) {
			...
			return false;
		if (isInherited == null) {
			if (other.isInherited != null)
				return false;
		} else if (!isInherited.equals(other.isInherited))
			return false;
		if (tilteOfTheFolder == null) {
			if (other.tilteOfTheFolder != null)
				return false;
		} else if (!tilteOfTheFolder.equals(other.tilteOfTheFolder))
			return false;
		return true;
	}
