...
public interface DocumentManagerBo {
	...
	public void uploadFileForUser(InputStream stream, String packagePath, String fileName,Integer userId, 
			Integer orgId,Integer solutionId,String fileDesc,String solutioName,JSONArray properties)  throws VyasaException ,NoSuchRepositoryException, RepositoryException;
	...
	public List<DocumentWrapper> getMyContentForCurrentUser(String currentDirectory,Integer userId, Integer orgId, Integer solutionId,String solutionName);
	public List<DocumentWrapper> getSharedContentForCurrentUser(String currentDirectory, Integer userId, Integer orgId,Integer solutionId,String solutionName);
	...
	public List<DocumentWrapper> getContentForCurrentUserAtDirectory(String currentDirectory, Integer userId, Integer orgId,Integer solutionId, String currentPrivilegeOnFolder,String requestOrigin,String solutionName);
	...
	public JSONArray getUserSecurityProfileForCurrentContext(Integer orgId, Integer userId, Integer solutionId)
			throws Throwable;
	JsonArray getOrgForUserInCurrentContent(Integer solutionId, Integer userId, Integer orgId,
			String ORG_UNIT_DIMENSION_NAME,String solutionName) throws Throwable;
	...
	public List<CollaborationErrorLog> processBulkUpload(Workbook uploadedWorkbook, Integer orgId, String fileLocation,	String fileName, Integer solutionId, String solutionName,Integer userId, String userName, Directory migrationRootDirectoryDetails) throws Throwable;
	public Workbook generateValidationReport(List<CollaborationErrorLog> errorLogList)  throws VyasaException ;
	public List<CollaborationErrorLog> validateHeaders(Workbook uploadedWorkbook);
