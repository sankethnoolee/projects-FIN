...
import com.fintellix.platformcore.search.dao.SolutionSpecificSessionFinder;
import com.fintellix.platformcore.utils.DBSwitch;
/**
...
public class VyasaHibernateDaoSupport {
	...
	@Autowired
	private SolutionSpecificSessionFinder solutionSpecificSessionFinder; 
	private final Logger logger = LoggerFactory.getLogger(getClass());
	
	protected DBSwitch dbType;
	
	/**
	 * @return the dbType
	 */
	public DBSwitch getDbType() {
		return dbType;
	}
	 ...
	 */
	public void setDbType(DBSwitch dbType) {
		this.dbType = dbType;
	}
	...
	public Session getCurrentSolutionSessionBySolutionName(String solutionName) {
		return solutionSpecificSessionFinder.getSessionFactory(solutionName).getCurrentSession();
	}

	
	public SolutionSpecificSessionFinder getSolutionSpecificSessionFinder() {
		return solutionSpecificSessionFinder;
	}

	public void setSolutionSpecificSessionFinder(
			SolutionSpecificSessionFinder solutionSpecificSessionFinder) {
		this.solutionSpecificSessionFinder = solutionSpecificSessionFinder;
	}
	...
	public void saveOrUpdateAll(final Collection entities) {
		...
		for (Object entity : entities) {
			...
			if (i % 1500 == 0) { s.flush(); s.clear(); i=0;logger.debug("Collection -- Entity type --"+entity.getClass().getName());}
		}
	}
