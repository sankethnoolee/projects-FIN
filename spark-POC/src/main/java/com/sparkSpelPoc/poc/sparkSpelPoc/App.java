...
public class App {
	...
	public static void main(String[] args) {
		...
		SparkSession spark = SparkSession.builder()
	            .appName("test query").master("spark://blrdevapp038.fintellix.com:7077")
	            .config("spark.authenticate.secret", "LxlnjG8F0GJfIW2sU8MkZUCIFIQwUXXW")
    ...
    public static void main(String[] args) {
    	...
    	Map<Integer,String> valIdsExpressionMap = new HashMap<Integer,String>();
    	valIdsExpressionMap.put(1, "CREATED_BY>=ORG_ID");
    	valIdsExpressionMap.put(0, "DIRECTORY_NAME==DIRECTORY_DESC");
    	
    	Map<Integer,String> valIdsColumnsUsedMap = new HashMap<Integer,String>();
    	valIdsColumnsUsedMap.put(1, "CREATED_BY,ORG_ID");
    	valIdsColumnsUsedMap.put(0, "DIRECTORY_NAME,DIRECTORY_DESC");
    	
        SparkJob sparkJob = new SparkJob(args,valIdsExpressionMap,valIdsColumnsUsedMap);
        try {
            sparkJob.startJob();
